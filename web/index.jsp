    ...
    <body>
        ...
        <div id="page-wraper">
            ...
            <section class="section about-me" >
                ...
                <div>
                    <div class="header-slider normal-slider">
                        <div class="header-slider-item" >
                            <img width="100%" height: auto src="img/khong muon yeu lai cang say dam.jpg" alt="Slider Image" />                               
                        </div>
                        <div class="header-slider-item" >
                            <img width="100%" height: auto src="img/mot buoc yeu van dam dau_bia.jpg" alt="Slider Image" />                               
                        </div>
                        <div  class="header-slider-item" >
                            <img width="100%" height: auto src="img/cang niu giu cang de mat_bia.jpg" alt="Slider Image" />                              
                        </div>
                    </div>
                </div>
                ...
                <div class="brand">
                    <div class="container-fluid">
                        <h1 style="color: #bd2130">Nghệ sĩ nổi bật</h1>
                        <div class="brand-slider">
                            <c:forEach items="${requestScope.sng}" var="s">
                                <div class="brand-item">
                                    <a href="singer?id=${s.NId}"><img width="100%" height="150px" src="img/CaSi/${s.img}" alt=""></a>
                                </div>
                ...
                <div class="featured-product product">
                    <div class="container-fluid">
                        ...
                        <div class="row align-items-center product-slider product-slider-4">
                            ...
                            <c:forEach items="${requestScope.new}" var="s">
                                <div class="col-lg-3">
