      ...
      <section class="section about-me" >
        ...
        <!-- Bottom Bar End -->     
                        ...
                        <div class="featured-product product">
                            <div class="container-fluid">
                                ...
                                <div class="row align-items-center product-slider product-slider-4">
                                    <c:forEach items="${requestScope.nats}" var="s">
                                        <div class="col-lg-3">
                                        <div class="product-item">
                                            <div class="product-title">
                                                <a href="natural?id=${s.QId}">${s.name}</a>
     
                                            </div>
                                            <div class="product-image">
                                                <a href="natural?id=${s.QId}">
                                                    <img height="150px" src="${s.img}" alt="Product Image">
                                                </a>
                        ...
                        <div class="featured-product product">
                            <div class="container-fluid">
                                <div class="section-header">
                                    <h1>Nhạc không lời</h1>
                                </div>
                                <div class="row align-items-center product-slider product-slider-4">
                                    <c:forEach items="${requestScope.pianos}" var="s">
                                        <div class="col-lg-3">
                                        <div class="product-item">
                                            <div class="product-title">
                                            ...
                                            <div class="product-image">
                                                <a href="song?id=${s.SId}">
                                                    <img height="150px" src="img/${s.img}" alt="Product Image">
                                                </a>
                        ...
                        <div class="featured-product product">
                            <div class="container-fluid">
                                <div class="section-header">
                                    <h1>Nhạc Trịnh bất hủ</h1>
                                </div>
                                <div class="row align-items-center product-slider product-slider-4">
                                    <c:forEach items="${requestScope.trinhs}" var="s">
                                        <div class="col-lg-3">
                                        <div class="product-item">
                                            <div class="product-title">
                                                <a href="song?id=${s.SId}">${s.name}</a>
