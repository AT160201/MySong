        ...
        <div id="page-wraper">
            ...
            <section class="section about-me" >
                ...
                <div class="signin-form">
                    ...
                    <form action="update?sid=${song.SId}" method="post" class="register-form" id="login-form">
                        <div class="form-group">

                            Tên bài hát: <input type="text" name="name" id="your_name" value="${song.name}"/>
                        </div>
                        <div class="form-group">

                            Ca sĩ: <input type="text" name="singer" id="your_pass" value="${song.singer.name}"/>
                        </div>

                        <div class="form-group">

                            MP3: <input type="text" name="mp3" id="your_pass" value="${song.mp3}"/>
                        </div>

                        <div class="form-group">

                            Image: <input type="text" name="img" id="your_pass" value="${song.img}"/>
                        </div>
                         <div class="form-group">

                            Date: <input type="date" name="date" id="your_pass" value="${song.date}"/> (yyyy-dd-MM)
                        </div>
