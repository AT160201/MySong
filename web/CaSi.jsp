                        ...
                        <div class="col-md-12">
                            <div class="row p-2 bg-white border rounded">
                                ...
                                <div class="col-md-5 mt-1">
                                    <img class="img-fluid img-responsive rounded product-image" src="img/CaSi/${sger.img}">
                                    <h2></h2>
                                    <h2 style="color: #bd2130 ">${sger.name}</h2>
                                </div>
                                        ...
                                        <div class="d-flex justify-content-center row">
                                            <div class="col-md-12">
                                                <div class="row p-2 bg-white border rounded">
                                                    ...
                                                    <div class="col-md-2">
                                                        <a href="casiplayer?cid=${sger.NId}&sid=${s.SId}"> <img class="img-fluid img-responsive rounded product-image" src="img/${s.img}"></a>
                                                    </div>
                                                    <div class="col-md-9">
                                                        <div class="mt-1 mb-1 spec-1">
                                                            <a href="casiplayer?cid=${sger.NId}&sid=${s.SId}"><h3>${s.name}</h3></a>
                                                    ...
                                                    <div class="align-items-center align-content-center col-md-1 border-left">
