                            ...
                            <div class="d-flex justify-content-center row">
                                <div class="col-md-11">
                                    <div class="row p-2 bg-white border rounded">
                                        ...
                                        <div class="col-md-2 mt-1"><a href="song?id=${s.SId}"><img height="50px" class="img-fluid img-responsive rounded product-image" src="img/${s.img}"></a></div>
                                        ...
                                        <div class="col-md-2 mt-1">
                                            <a href="Xoa?sid=${s.SId}">delete</a><br/>
                                            <a href="update?sid=${s.SId}">update</a>
                                        </div> 
                                    </div>
